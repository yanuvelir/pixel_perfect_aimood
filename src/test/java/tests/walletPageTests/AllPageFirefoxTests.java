...
public class AllPageFirefoxTests extends BaseTest {
    ...
    public void allHeaderWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//header[@class='header-wrapper']",
                ...
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_allHeaderWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_allHeaderWalletPage/difference.png");
    ...
    public void getStartedHeaderWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='header-drop-down'][1]",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_getStartedHeaderWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_getStartedHeaderWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_getStartedHeaderWalletPage/difference.png");
    ...
    public void learnHeaderWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//li[@class='header-nav-item learn-nav-item']/div[@class='header-drop-down']",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_learnHeaderWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_learnHeaderWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_learnHeaderWalletPage/difference.png");
    ...
    public void resourcesHeaderWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//nav/ul/li[5]/div[@class='header-drop-down']",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_resourcesHeaderWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_resourcesHeaderWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_resourcesHeaderWalletPage/difference.png");
...
//        //Run the Pixel perfect test for a selected element
//        pixelPerfectAssert.byElement("//div[@class='header-drop-down'][1]",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_langItemHeaderWalletPage/real_life_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_langItemHeaderWalletPage/mock_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_langItemHeaderWalletPage/difference.png");
//
//    }
    ...
    public void mainSectionWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//section[@data-testid='wallet-program-section']",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_mainSectionWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_mainSectionWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_mainSectionWalletPage/difference.png");
    ...
    public void delegatedSectionWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//section[@data-testid='delegated-section']",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_delegatedSectionWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_delegatedSectionWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_delegatedSectionWalletPage/difference.png");
    ...
    public void allFooterWalletPage(String wallet_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//footer[@data-testid='footer-new']",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_allFooterWalletPage/real_life_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_allFooterWalletPage/mock_screenshot.png",
                ScShotDir+"Wallet_page/EnFirefox/Screenshots_allFooterWalletPage/difference.png");
...
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_partnFooterWalletPage/real_life_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_partnFooterWalletPage/mock_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_partnFooterWalletPage/difference.png");
//
//    }
//
//    @Parameters({"wallet_page", "ScShotDir"})
...
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_subFooterWalletPage/real_life_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_subFooterWalletPage/mock_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_subFooterWalletPage/difference.png");
//
//    }
//
//    @Parameters({"wallet_page", "ScShotDir"})
...
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_copFooterWalletPage/real_life_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_copFooterWalletPage/mock_screenshot.png",
//                ScShotDir+"Wallet_page/EnFirefox/Screenshots_copFooterWalletPage/difference.png");
//
//    }
