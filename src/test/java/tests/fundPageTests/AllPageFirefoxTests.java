...
public class AllPageFirefoxTests extends BaseTest {
    ...
    public void getStartedHeaderFundPage(String fund_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='header-drop-down'][1]",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_getStartedHeaderFundPage/real_life_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_getStartedHeaderFundPage/mock_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_getStartedHeaderFundPage/difference.png");
    ...
    public void learnHeaderFundPage(String fund_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//li[@class='header-nav-item learn-nav-item']/div[@class='header-drop-down']",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_learnHeaderFundPage/real_life_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_learnHeaderFundPage/mock_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_learnHeaderFundPage/difference.png");
    ...
    public void resourcesHeaderFundPage(String fund_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//nav/ul/li[5]/div[@class='header-drop-down']",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_resourcesHeaderFundPage/real_life_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_resourcesHeaderFundPage/mock_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_resourcesHeaderFundPage/difference.png");
...
//        //Run the Pixel perfect test for a selected element
//        pixelPerfectAssert.byElement("//div[@class='header-drop-down'][1]",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_langItemHeaderFundPage/real_life_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_langItemHeaderFundPage/mock_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_langItemHeaderFundPage/difference.png");
//
//    }
    ...
    public void mainSectionFundPage(String fund_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//section[@data-testid='fund-program-section']",
                ...
                ScShotDir+"Fund_page/EnFirefox/Screenshots_mainSectionFundPage/mock_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_mainSectionFundPage/difference.png");
    ...
    public void allFooterFundPage(String fund_page, String ScShotDir) throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//footer[@data-testid='footer-new']",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_allFooterFundPage/real_life_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_allFooterFundPage/mock_screenshot.png",
                ScShotDir+"Fund_page/EnFirefox/Screenshots_allFooterFundPage/difference.png");
...
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_partnFooterFundPage/real_life_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_partnFooterFundPage/mock_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_partnFooterFundPage/difference.png");
//
//    }
//
//    @Parameters({"fund_page", "ScShotDir"})
...
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_subFooterFundPage/real_life_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_subFooterFundPage/mock_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_subFooterFundPage/difference.png");
//
//    }
//
//    @Parameters({"fund_page", "ScShotDir"})
...
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_copFooterFundPage/real_life_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_copFooterFundPage/mock_screenshot.png",
//                ScShotDir+"Fund_page/EnFirefox/Screenshots_copFooterFundPage/difference.png");
//
//    }
