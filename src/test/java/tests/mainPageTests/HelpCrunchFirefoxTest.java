...
public class HelpCrunchFirefoxTest extends BaseTest {
    public HelpCrunchFirefoxTest(){
        super("win_firefox");
    }
    ...
    public void helpCrunchMainPage() throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='hcw-chat helpcrunch-state-start-screen helpcrunch-chat-position-right hcw-widget-layout-1']",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchMainPage/difference.png");
    ...
    public void helpCrunchStartConversationMainPage() throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='hcw-chat helpcrunch-state-chat helpcrunch-chat-position-right hcw-widget-layout-1']",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchStartConversationMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchStartConversationMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchStartConversationMainPage/difference.png");
    ...
    public void helpCrunchTextAreaMainPage() throws IOException, InterruptedException {
        ...
        //Run the Pixel perfect test for a selected element
        pixelPerfectAssert.byElement("//div[@class='hcw-chat helpcrunch-state-chat helpcrunch-chat-position-right hcw-widget-layout-1']",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchTextAreaMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchTextAreaMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchTextAreaMainPage/difference.png");
    ...
    public void helpCrunchKnowledgeBaseMainPage() throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='hcw-chat helpcrunch-state-knowledge-base helpcrunch-chat-position-right hcw-widget-layout-1']",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchKnowledgeBaseMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchKnowledgeBaseMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchKnowledgeBaseMainPage/difference.png");
    ...
    public void helpCrunchSendMessageMainPage() throws IOException, InterruptedException {
        ...
        //Run the Pixel perfect test for a selected element
        pixelPerfectAssert.byElement("//div[@class='hcw-chat helpcrunch-state-chat helpcrunch-chat-position-right hcw-widget-layout-1']",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchSendMessageMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchSendMessageMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnFirefox/Screenshots_helpCrunchSendMessageMainPage/difference.png");
