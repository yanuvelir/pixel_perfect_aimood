...
public class AllPageChromeTests extends BaseTest{
    ...
    public void allHeaderMainPage() throws IOException, InterruptedException {
        ...
        pixelPerfectAssert.byElement("//div[@class='header-wrapper']",
                "Screenshots/Main_page/EnChrome/Screenshots_allHeaderMainPage/real_life_screenshot.png",
                "Screenshots/Main_page/EnChrome/Screenshots_allHeaderMainPage/mock_screenshot.png",
                "Screenshots/Main_page/EnChrome/Screenshots_allHeaderMainPage/difference.png");
